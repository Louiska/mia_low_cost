...
def run_dataloader(dataloader, model):
    total_correct_mem_pred, total_correct_non_mem_pred, total_mem, total_non_mem = 0,0,0,0
    ...
    print(f"Correct prediction and not member: {total_correct_non_mem_pred}/{total_non_mem}")
